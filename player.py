...
class Player(CircleShape):
    ...
    def shoot(self):
        ...
        shot = Shot(self.position.x, self.position.y)   #kreirati pucanj na poziciji igrača
        shot.velocity = pygame.Vector2(0, 1).rotate(self.rotation) * PLAYER_SHOOT_SPEED     #postaviti brzinu metka
